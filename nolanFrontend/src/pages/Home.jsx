...
import "./Home.css";
import fvid from "../assets/fvid.mp4";
			...
			<main className='home'>
				<section className='hero'>
					<div className='hero-text'>
						<h1>
							Bring your film project to life from <span>idea</span> to{" "}
					...
					<div className='hero-video'>
						<video controls>
							<source src={fvid} type='video/mp4' />
				...
				<section className='features-section'>
					...
					<div className='bottom-row'>
						<div className='feature'>
							...
							<h3>Analytics</h3>
							<p>
								Instantly identify plot holes and receive thorough script
								coverage analysis. Perfect your screenplay with targeted
								insights and scores.
							</p>
						</div>
						...
						<div className='feature'>
							...
							<p>
								Streamline pre-production with automatic breakdowns that quickly
								organize script elements for efficient planning.
							</p>
						</div>
					</div>
				</section>
					...
					<div className='content-wrapper'>
						<div className='text-content'>
							...
							<p className='description'>
								...
								NolanAI to break down scripts, create pitch decks and
								storyboards, and reach his ultimate goal.
							</p>
					...
					<div className='stats-container'>
						<div className='stat-item'>
							<div className='icon-circle'>
								<svg className='icon' viewBox='0 0 24 24'>
									<path
										d='M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm4 5.28c-1.23-.37-2.22-1.17-2.8-2.18l-1-1.6c-.41-.65-1.11-1-1.84-1-.78 0-1.59.5-1.78 1.44S7 23 7 23'
										fill='#ff9800'
									/>
								</svg>
							</div>
						...
						<div className='stat-item'>
							<div className='icon-circle'>
								<svg className='icon' viewBox='0 0 24 24'>
									<path
										d='M12.5 6.9c-2.65 0-5 2.35-5 5s2.35 5 5 5 5-2.35 5-5-2.35-5-5-5zm0 8c-1.65 0-3-1.35-3-3s1.35-3 3-3 3 1.35 3 3-1.35 3-3 3z'
										fill='#ff9800'
									/>
								</svg>
							</div>
				...
				<footer className='footer'>
					<div className='footer-content'>
						...
						<div className='social-media'>
							...
							<i class='ki-filled ki-social-media'></i>
						</div>
					</div>
				</footer>
			</main>
